...
namespace NSE.Pagamentos.API.Data.Repository
{
    public class PagamentoRepository : IPagamentoRepository
    {
        ...
        public void AdicionarPagamento(NSE.Pagamentos.API.Models.Pagamento pagamento)
        {
        ...
        public async Task<NSE.Pagamentos.API.Models.Pagamento> ObterPagamentoPorPedidoId(Guid pedidoId)
        {
